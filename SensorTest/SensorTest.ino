...
{
  Softi2c i2c(A2, A3);
  uint8_t data[]= {0b10101010, 0b11001100, 0b00001111, 0b00111100};
  i2c.write(0b00001111, 0b11101000, data, 4);
  assertEqual(i2c.symbolStream, "S00011110R11101000R10101010R11001100R00001111R00111100RE", i2c.symbolStream);
}
